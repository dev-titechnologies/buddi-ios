...
public class ReviewHistoryDB: NSManagedObject {
    ...
    class func createBookingEntry(reviewModel: ReviewHistoryModel) {
        
        print("*** Review ID:",reviewModel.bookingId)
        ...
        do {
            ...
            if reviews.count > 0 {
                ...
                let review = NSEntityDescription.insertNewObject(forEntityName: "ReviewHistoryDB", into:context) as! BookingHistoryDB
